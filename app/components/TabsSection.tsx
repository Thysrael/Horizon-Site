...
export function TabsSection({ sources, contributors, userVotedSourceIds }: TabsSectionProps) {
  return (
    <section className="relative overflow-hidden border-b border-gray-100 bg-gradient-to-b from-gray-50/50 to-white py-12">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <TabView sources={sources} contributors={contributors} userVotedSourceIds={userVotedSourceIds} />
      </div>
    </section>
  );
}
